...
ActiveRecord::Schema.define(version: 2020_09_08_141311) do
  ...
  create_table "task_actions", force: :cascade do |t|
    ...
    t.index ["done_at"], name: "index_task_actions_on_done_at"
    t.index ["priority"], name: "index_task_actions_on_priority"
    t.index ["state"], name: "index_task_actions_on_state"
